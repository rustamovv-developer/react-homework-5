  ...
  return (
    <section className="privacy">
      <div className="privacy__info">
        ...
        <h4 className="privacy__h4">Last modification: 1/8/2021</h4>
        ...
        <h3 className="privacy__h3">Who We Are and What This Policy Covers</h3>
        <p className="privacy__text">
        ...
        <h3 className="privacy__h3">Information We Collect</h3>
        <p className="privacy__text">
